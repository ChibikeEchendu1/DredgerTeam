...
class MyContactLisBosst extends Component {
  constructor(props) {
    super(props);
      ...
      return (
        <View>
          ...
          <Text style={{color: 'white', marginTop: 20}}>
            Total Trucks: {this.props.item.Money}
          </Text>

          <Text style={{color: 'white'}}>
            Five Ton Trucks: {this.props.item.fiveTMoney}
          </Text>
          <Text style={{color: 'white'}}>
            Ten Ton Trucks: {this.props.item.tenTMoney}
          </Text>
          <Text style={{color: 'white'}}>
            Fifteen Ton Trucks: {this.props.item.fifteenTMoney}
          </Text>
          <Text style={{color: 'white'}}>
            Thirty Ton Trucks: {this.props.item.thirtyTMoney}
          </Text>
        </View>
      );
