...
import {NameChanged, FetchStaff, CodeChanged, AddStaffBoss} from '../actions';
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
          ...
          />
          <BossHeader title={'Home'} navigation={this.props.navigation} />
          <Input
...
export default connect(
  mapStateToProps,
  {NameChanged, FetchStaff, CodeChanged, AddStaffBoss},
)(BossScreenView);
